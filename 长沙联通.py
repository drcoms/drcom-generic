# This version has passed the test.
...
DEBUG = True
# basic configuration
server = "58.20.127.106" # Auth server ip
username = ""
password = ""
host_name = "LIYUANYUAN"
host_os = "8089D"
host_ip = "119.39.42.28" # your ip, the server wouldn't check this, so it's a nonsense 
dhcp_server = "119.39.42.1"
mac = 0xf8a963a2f70f
...
def mkpkt(salt, usr, pwd, mac):
    ...
    data += '\x5b\x88' #unknown, filled numbers randomly =w=
